...
file = "C:/Users/khajuria_S/Desktop/Test Data for Selenium/Data-Driven-Interst-Testing.xlsx"
...
for r in range(2,rows+1):
    ...
    if float(Expected_Value)==float(act_value):
        print("Test Passed")
        ExcelUtils.writeData(file,'Sheet1',r,6,'Passed')
        ExcelUtils.fillGreenColor(file,'Sheet1',r,6)
    else:
        print("Test Failed")
        ExcelUtils.writeData(file,'Sheet1',r,6,'Failed')
        ExcelUtils.fillRedColor(file,'Sheet1',r,6)
    driver.find_element(By.XPATH, "//input[@id='deposit_amount']").clear()
